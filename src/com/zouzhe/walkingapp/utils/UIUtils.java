...
public class UIUtils {
	...
	public static Context getContext() {
		return Walkingaplication.getApplication();
	}

	public static Thread getMainThread() {
		return Walkingaplication.getMainThread();
	}

	public static long getMainThreadId() {
		return Walkingaplication.getMainThreadId();
	}
	...
	public static Handler getHandler() {
		return Walkingaplication.getMainThreadHandler();
	}
...
//		}
	...
	private static void showToast(String str) {
		Context frontActivity = Walkingaplication.getApplication();
